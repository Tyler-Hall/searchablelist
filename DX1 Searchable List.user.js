...
$('#metroDdlddlDealershipSelection').one('DOMNodeInserted', function(event) {
	setTimeout(function(){
  		$('#metroDdlddlDealershipSelection').wrapInner('<ul id="dx1DealerSelect" class="dx1DealerSelect"></ul>');
        $('#dx1DealerSelect > li > a').each(function(){
            $(this).addClass("name");
        });
        $('#metroDdlddlDealershipSelection').prepend('<input class="search" placeholder="Search" />' );
        var options = {
            valueNames:['name'],
          listClass: 'dx1DealerSelect',
            item:'<li><a class="name"></a></li>',
            page:9999
        };
        var userList = new List('metroDdlddlDealershipSelection', options);
        $('#metroDdlddlDealershipSelection > input.search').focus();
    }, 500);
});

$('#metroDdlBtnddlDealershipSelection').click(function(){
    if($('#metroDdlddlDealershipSelection > input.search')){
        $('#metroDdlddlDealershipSelection > input.search').focus();
    }
});
